...
public class ItemCatService extends BaseService<ItemCat> {
    ...
    // return this.itemCatMapper.select(param);
    // }
    ...
    public static final String REDIS_KEY = "TAOTAO_MANAGE_ITEM_CAT_WEB_ALL";

    public static final Integer REDIS_TIME = 60 * 60 * 24 * 30;
