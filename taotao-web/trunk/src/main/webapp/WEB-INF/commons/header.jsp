		...
		<div id="nav-2013">
			...
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					...
					<li class="fore2" id="nav-fashion" clstag="homepage|keycount|home2013|07b"><a href="${url[0]}">${title[0]} </a></li>
					<li class="fore3" id="nav-chaoshi" clstag="homepage|keycount|home2013|07c"><a href="${url[1]}">${title[1]}</a></li>
					<li class="fore4" id="nav-tuan" clstag="homepage|keycount|home2013|07d"><a href="${url[2]}" target="_blank">${title[2]}</a></li>
					<li class="fore5" id="nav-auction" clstag="homepage|keycount|home2013|07e"><a href="${url[3]}">${title[3]}</a></li>
					<li class="fore6" id="nav-shan" clstag="homepage|keycount|home2013|07f"><a href="${url[4]}" target="_blank">${title[4]}</a></li>
					<li class="fore7" id="nav-jinrong" clstag="homepage|keycount|home2013|07g1"><a href="${url[5]}" target="_blank">${title[5]}</a></li>
				</ul>
		</div>
	</div>
</div>
