...
<script type="text/javascript">
/*滚动广告  */
pageConfig.DATA_MScroll = ${indexScroll};
/*  [
     {
        "alt": "",
...
<div class="mc">
	<ul>
		<li class="odd" clstag="homepage|keycount|home2013|11b1"><a href="${indexAd4.url1 }" target="_blank" title="${indexAd4.title1 }">${indexAd4.title1 }</a></li>					
				<li clstag="homepage|keycount|home2013|11b1"><a href="${indexAd4.url2 }" target="_blank" title="${indexAd4.title2 }">${indexAd4.title2 }</a></li>
				<li class="odd" clstag="homepage|keycount|home2013|11b1"><a href="${indexAd4.url3 }" target="_blank" title=">${indexAd4.title3 }">${indexAd4.title3 }</a></li>					
				<li clstag="homepage|keycount|home2013|11b1"><a href="${indexAd4.url4 }" target="_blank" title="${indexAd4.title4 }">${indexAd4.title4 }</a></li>
	</ul>
</div>
</div>
<!--新闻结束-->
...
<ul class="lh" clstag="homepage|keycount|home2013|18a">
	<li><a href="${leftContentAndImgUrl1[0] }">${leftContentAndImgTitle1[0] }</a></li>
	<li><a href="${leftContentAndImgUrl1[1] }">${leftContentAndImgTitle1[1] }</a></li>
	<li><a href="${leftContentAndImgUrl1[2] }">${leftContentAndImgTitle1[2] }</a></li>
	<li><a href="${leftContentAndImgUrl1[3] }">${leftContentAndImgTitle1[3] }</a></li>
	<li><a href="${leftContentAndImgUrl1[4] }">${leftContentAndImgTitle1[4] }</a></li>
	<li><a href="${leftContentAndImgUrl1[5] }">${leftContentAndImgTitle1[5] }</a></li>
	<li><a href="${leftContentAndImgUrl1[6] }">${leftContentAndImgTitle1[6] }</a></li>
	<li><a href="${leftContentAndImgUrl1[7] }">${leftContentAndImgTitle1[7] }</a></li>
</ul>
...
<!-- 广告信息 -->
	<a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="${leftContentAndImgImg1[0] }" width="209" height="155" alt="" />
	</a>
</span>
</div>
</div>
...
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="52" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>大家电</h3>
  </div>
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="53" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>小家电</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="54" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>厨房电器</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="55" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>手机通讯</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="56" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>汽车五金</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="smc">
	<ul class="lh">
		<c:forEach items="${indexAdRight1}" var="c">
			<li class="fore1"><a target="_blank" title="${c.title}"
				href="${c.url}"> <img height="35" width="98" alt=""
					data-img="2" data-lazyload="${c.pic}" /></a></li>
		</c:forEach>
	</ul>
</div>
</div>
...
<div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">2F</b><b class="fixpng b4"></b></div>
<h2>个护美妆</h2>
</div>
<div class="mc">
<div class="style1">
<ul class="lh" clstag="homepage|keycount|home2013|18a">
	<li><a href="${leftContentAndImgUrl2[0] }">${leftContentAndImgTitle2[0] }</a></li>
	<li><a href="${leftContentAndImgUrl2[1] }">${leftContentAndImgTitle2[1] }</a></li>
	<li><a href="${leftContentAndImgUrl2[2] }">${leftContentAndImgTitle2[2] }</a></li>
	<li><a href="${leftContentAndImgUrl2[3] }">${leftContentAndImgTitle2[3] }</a></li>
	<li><a href="${leftContentAndImgUrl2[4] }">${leftContentAndImgTitle2[4] }</a></li>
	<li><a href="${leftContentAndImgUrl2[5] }">${leftContentAndImgTitle2[5] }</a></li>
	<li><a href="${leftContentAndImgUrl2[6] }">${leftContentAndImgTitle2[6] }</a></li>
	<li><a href="${leftContentAndImgUrl2[7] }">${leftContentAndImgTitle2[7] }</a></li>
</ul>
<span clstag="homepage|keycount|home2013|18b">
<!-- 广告信息 -->
	<a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="${leftContentAndImgImg2[0] }" width="209" height="155" alt="" />
	</a>
</span>
</div>
</div>
...
<div class="m plist">
<div class="tab-arrow"><b></b></div>
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="58" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>国际大牌</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="59" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>国妆名品</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="60" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>个人护理</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="61" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>香水彩妆</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="62" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>热销面膜</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="smc">
	<ul class="lh">
		<c:forEach items="${indexAdRight2}" var="c">
			<li class="fore1"><a target="_blank" title="${c.title}"
				href="${c.url}"> <img height="35" width="98" alt=""
					data-img="2" data-lazyload="${c.pic}" /></a></li>
		</c:forEach>
...
<div class="fr da209x180" clstag="homepage|keycount|home2013|19b">
<div class="slide" data-lazyload="9"></div>
</div>
<span class="clr"></span>
</div>
<!-- 二楼end-->
...
<div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">3F</b><b class="fixpng b4"></b></div>
<h2>电脑数码</h2>
</div>
<div class="mc">
<div class="style1">
<ul class="lh" clstag="homepage|keycount|home2013|18a">
	<li><a href="${leftContentAndImgUrl3[0] }">${leftContentAndImgTitle3[0] }</a></li>
	<li><a href="${leftContentAndImgUrl3[1] }">${leftContentAndImgTitle3[1] }</a></li>
	<li><a href="${leftContentAndImgUrl3[2] }">${leftContentAndImgTitle3[2] }</a></li>
	<li><a href="${leftContentAndImgUrl3[3] }">${leftContentAndImgTitle3[3] }</a></li>
	<li><a href="${leftContentAndImgUrl3[4] }">${leftContentAndImgTitle3[4] }</a></li>
	<li><a href="${leftContentAndImgUrl3[5] }">${leftContentAndImgTitle3[5] }</a></li>
	<li><a href="${leftContentAndImgUrl3[6] }">${leftContentAndImgTitle3[6] }</a></li>
	<li><a href="${leftContentAndImgUrl3[7] }">${leftContentAndImgTitle3[7] }</a></li>
	
</ul>
<span clstag="homepage|keycount|home2013|18b">
<!-- 广告信息 -->
	<a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="${leftContentAndImgImg3[0] }" width="209" height="155" alt="" />
	</a>
</span>
</div>
</div>
...
<div class="m plist">
<div class="tab-arrow"><b></b></div>
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="64" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>电脑平板</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="65" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>潮流影音</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="66" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>智能外设</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="67" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>DIY硬件</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="68" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>电竞游戏</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="smc">
	<ul class="lh">
		<c:forEach items="${indexAdRight3}" var="c">
			<li class="fore1"><a target="_blank" title="${c.title}"
				href="${c.url}"> <img height="35" width="98" alt=""
					data-img="2" data-lazyload="${c.pic}" /></a></li>
		</c:forEach>
...
<div class="fr da209x180" clstag="homepage|keycount|home2013|19b">
<div class="slide" data-lazyload="10"></div>
</div>
<span class="clr"></span>
</div>
<!-- 3楼end-->
...
<div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">4F</b><b class="fixpng b4"></b></div>
<h2>运动健身</h2>
</div>
<div class="mc">
<div class="style1">
<ul class="lh" clstag="homepage|keycount|home2013|18a">
	<li><a href="${leftContentAndImgUrl4[0] }">${leftContentAndImgTitle4[0] }</a></li>
	<li><a href="${leftContentAndImgUrl4[1] }">${leftContentAndImgTitle4[1] }</a></li>
	<li><a href="${leftContentAndImgUrl4[2] }">${leftContentAndImgTitle4[2] }</a></li>
	<li><a href="${leftContentAndImgUrl4[3] }">${leftContentAndImgTitle4[3] }</a></li>
	<li><a href="${leftContentAndImgUrl4[4] }">${leftContentAndImgTitle4[4] }</a></li>
	<li><a href="${leftContentAndImgUrl4[5] }">${leftContentAndImgTitle4[5] }</a></li>
	<li><a href="${leftContentAndImgUrl4[6] }">${leftContentAndImgTitle4[6] }</a></li>
	<li><a href="${leftContentAndImgUrl4[7] }">${leftContentAndImgTitle4[7] }</a></li>
</ul>
<span clstag="homepage|keycount|home2013|18b">
<!-- 广告信息 -->
	<a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="${leftContentAndImgImg4[0] }" width="209" height="155" alt="" />
	</a>
</span>
</div>
</div>
...
<div class="m plist">
<div class="tab-arrow"><b></b></div>
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="70" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>大牌速递</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="71" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>潮牌新品</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="72" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>运动鞋服</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="73" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>健身训练</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="74" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>休闲户外</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="smc">
	<ul class="lh">
		<c:forEach items="${indexAdRight4}" var="c">
			<li class="fore1"><a target="_blank" title="${c.title}"
					href="${c.url}"> <img height="35" width="98" alt=""
						data-img="2" data-lazyload="${c.pic}" /></a></li>
		</c:forEach>
...
<div class="fr da209x180" clstag="homepage|keycount|home2013|19b">
<div class="slide" data-lazyload="11"></div>
</div>
<span class="clr"></span>
</div>
<!-- 4楼end-->
...
<div class="floor"><b class="fixpng b b1"></b><b class="fixpng b b2"></b><b class="b b3">5F</b><b class="fixpng b4"></b></div>
<h2>居家生活</h2>
</div>
<div class="mc">
<div class="style1">
<ul class="lh" clstag="homepage|keycount|home2013|18a">
	<li><a href="${leftContentAndImgUrl5[0] }">${leftContentAndImgTitle5[0] }</a></li>
	<li><a href="${leftContentAndImgUrl5[1] }">${leftContentAndImgTitle5[1] }</a></li>
	<li><a href="${leftContentAndImgUrl5[2] }">${leftContentAndImgTitle5[2] }</a></li>
	<li><a href="${leftContentAndImgUrl5[3] }">${leftContentAndImgTitle5[3] }</a></li>
	<li><a href="${leftContentAndImgUrl5[4] }">${leftContentAndImgTitle5[4] }</a></li>
	<li><a href="${leftContentAndImgUrl5[4] }">${leftContentAndImgTitle5[5] }</a></li>
	<li><a href="${leftContentAndImgUrl5[4] }">${leftContentAndImgTitle5[6] }</a></li>
	<li><a href="${leftContentAndImgUrl5[4] }">${leftContentAndImgTitle5[7] }</a></li>
</ul>
<span clstag="homepage|keycount|home2013|18b">
<!-- 广告信息 -->
	<a target="_blank" title="" href="http://c.fa.jd.com/adclick?sid=2&cid=601&aid=3624&bid=0&unit=35989&advid=105087&guv=&url=http://sale.jd.com/act/PzKvRu4Ld5YnG1Ej.html">
		<img data-img="2" data-lazyload="${leftContentAndImgImg5[0] }" width="209" height="155" alt="" />
	</a>
</span>
</div>
</div>
...
<div class="m plist">
<div class="tab-arrow"><b></b></div>
<div class="sm sm2 fore1 curr"  data-widget="tab-item" data-tag="76" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>大牌名品</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="sm sm2 fore2"  data-widget="tab-item" data-tag="77" clstag="homepage|keycount|home2013|18d">
  <div class="smt">
    <h3>床上用品</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore3"  data-widget="tab-item" data-tag="78" clstag="homepage|keycount|home2013|18e">
  <div class="smt">
    <h3>厨房用品</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore4"  data-widget="tab-item" data-tag="79" clstag="homepage|keycount|home2013|18f">
  <div class="smt">
    <h3>居家百货</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
</div><div class="sm sm2 fore5"  data-widget="tab-item" data-tag="80" clstag="homepage|keycount|home2013|18g">
  <div class="smt">
    <h3>家装建材</h3>
  </div>
  <div class="smc" data-widget="tab-content">
...
<div class="smc">
	<ul class="lh">
		<c:forEach items="${indexAdRight5}" var="c">
			<li class="fore1"><a target="_blank" title="${c.title}"
				href="${c.url}"> <img height="35" width="98" alt=""
					data-img="2" data-lazyload="${c.pic}" /></a></li>
		</c:forEach>
...
<div class="fr da209x180" clstag="homepage|keycount|home2013|19b">
<div class="slide" data-lazyload="12"></div>
</div>
<span class="clr"></span>
</div>
<!-- 5楼end-->
