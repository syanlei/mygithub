...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	//var jssons=[{"id":6,"countyName":"天心区","phone":"18710738511","updated":1441944650000,"created":1441944650000,"townName":"小河村123","userId":11,"cityName":"长沙市","name":"shangshanew","provinceName":"湖南省"},{"id":8,"countyName":"青山区","phone":"18701738510","updated":1441947210000,"created":1441947210000,"townName":"呵呵呵呵","userId":11,"cityName":"包头市","name":"xinzhongguo","provinceName":"内蒙古"},{"id":7,"countyName":"赤水市","phone":"18701738510","updated":1441946991000,"created":1441946991000,"townName":"大河村1#","userId":11,"cityName":"遵义市","name":"hainan","provinceName":"贵州省"}];
	//var jsssons=JSON.parse(jssons);
	
	function queryTaskList(){
		$.ajax({
 		   type: "GET",
 		   url: "/service/ship/queryAllTake",
	...
	var fff=0;
	var move=0;
	function item_take(jssons){
		if(jssons=="0"){
			newConsignee();
		}
		$("#consignee-list").animate({left:'0px'}, "slow");
		fff=0;
		move=0;
		fff=jssons.length;	
		$("#consignee-list").html('');
		$.each(jssons, function (n, value) {
			var item_style="";
			var item_default="";
			var item_delete="";
			if(jssons.length!=1){
				item_delete='<a href="#none" class="ftx-05 del-consignee " fid="137617472" onclick="deleteTake('+value.id+')">删除</a>';
			}
			if(n==0){
				item_style='item-selected';
				$("#receiverNameId").val(value.name);
				$("#receiverMobileId").val(value.phone);
				$("#receiverStateId").val(value.provinceName);
				$("#receiverCityId").val(value.cityName);
				$("#receiverDistrictId").val(value.countyName);
				$("#receiverAddressId").val(value.townName);
				
			}else{
				item_default='<a href="#none" class="ftx-05 mr10 setdefault-consignee " fid="137617472" onclick="setDefault('+value.id+')">设为默认地址</a>';
			}
			var li= '<li class="ui-switchable-panel" id="consignee_index_137617472" selected="selected" style="cursor: pointer;">'
				+'<div class="consignee-item '+item_style+' consigneeId="137617472" id="consignee_index_div_137617472">'
					+'<b></b>'
				+'<div class="user-name">'
					+'<div class="fl"><strong limit="4">'+value.name+'</strong>&nbsp;&nbsp;收</div>'
					+'<div class="fr">'+value.phone+'</div>'
					+'<div class="clr"></div>'
				+'</div>'
				+'<div class="mt10" limit="15">'+value.provinceName+' '+value.cityName+' '+value.countyName+' </div>'
				+'<div class="adr-m" limit="30">'+value.townName+'</div>'
				+'<div class="op-btns ar">'
				+item_default
			    +'<a href="#none" class="ftx-05 mr10 edit-consignee" fid="137617472" onclick="takeedit('+value.id+')">编辑</a>'
				+item_delete
				+'</div>'
			+'</div>'
		+'</li>';
			$("#consignee-list").append(li);
    	});  
	}
	</script>
	<style type="text/css">
...
<form id="orderForm" class="hide">
		...
		<c:forEach items="${carts }" var="cart" varStatus="status">
			...
			<c:set var="totalNum"  value="${ totalNum + cart.num}"/><!-- 1 -->
		...
		<input type="hidden" name="OrderShipping.receiverName"  id="receiverNameId" />   		<!--收货人全名  -->
		<input type="hidden" name="OrderShipping.receiverMobile" id="receiverMobileId" />		<!--移动电话  -->
		<input type="hidden" name="OrderShipping.receiverState" id="receiverStateId"/>		<!--省份  -->
		<input type="hidden" name="OrderShipping.receiverCity" id="receiverCityId"/>			<!--城市  -->
		<input type="hidden" name="OrderShipping.receiverDistrict" id="receiverDistrictId"/>	<!--县区  -->
		<input type="hidden" name="OrderShipping.receiverAddress" id="receiverAddressId"/>	<!--具体地址  -->
		
		
		<input type="hidden" name="Invocie.invocieHead" id="hiddenInvocieHead"  />		<!--发票抬头  -->
		<input type="hidden" name="Invocie.invocieContent" id="hiddeninvocieContent" />	<!--发票内容  -->
		<input type="hidden" name="Invocie.invocieMode" id="hiddeninvocieMode" />		<!--开票方式  -->
		<input type="hidden" name="Invocie.invociePhone" id="hiddeninvociePhone" />		<!--联系人电话  -->
		<input type="hidden" name="Invocie.invocieName" id="hiddeninvocieName" />		<!--联系人  -->
...
<div class="step-tit">
	<h3>收货人信息</h3>
	<div class="extra-r">
		<a href="#" id="newConsignee" onclick="newConsignee()">新增收货地址</a>
<!-- 		<a href="#none" class="ftx-05" onclick="use_NewConsignee()">新增收货地址</a> -->
	</div>
</div>
<div class="step-cont">
	<div class="consignee-list" id="consignee-list1">
		<a href="#none" id="prev" class="prev arrow-btns" onclick="moveleft()"></a>
		<a href="#none" id="next" class="next arrow-btns" onclick="moveright()"></a>
		<script type="text/javascript">
			...
			function moveleft(){
				...
				if(move>-ccc){
					move=move-230;
					$("#consignee-list").animate({left: move+'px'}, "slow");
				}
				return false;
			}
			function moveright(){
		...
		<div id="consignee1" class="list-cont ui-switchable-body">
            <div id="consignee-ret"></div>
   						<ul class="ui-switchable-panel-main" id="consignee-list" style="position: relative">
				<!---->
 ...
 <!-- <li class="ui-switchable-panel" id="consignee_index_137617472" selected="selected" style="cursor: pointer;">
	<div class="consignee-item item-selected" consigneeId="137617472" id="consignee_index_div_137617472">
		<b></b>
		<div class="user-name">
			<div class="fl"><strong limit="4">张志君22</strong>&nbsp;&nbsp;收</div>
		...
		<div class="op-btns ar">
			<a href="#none" class="ftx-05 mr10 setdefault-consignee " fid="137617472" onclick="setDefault(6)">设为默认地址</a>
		    <a href="#none" class="ftx-05 mr10 edit-consignee" fid="137617472" onclick="takeedit(6)">编辑</a>
			<a href="#none" class="ftx-05 del-consignee " fid="137617472" onclick="deleteTake(5)">删除</a>
		</div>
...
<div id="shipEdit" class="easyui-window" title="编辑收货地址" 
		data-options="modal:true,closed:true,href:'/ship/shipEdit.html'" 
		style="width:500px;height:300px;padding:10px;">
</div>

<div id="shipAdd" class="easyui-window" title="新增收货地址" 
		data-options="modal:true,closed:true,href:'/ship/shipAdd.html'" 
		style="width:500px;height:300px;padding:10px;">
</div>
		...
		<div class="list-cont">
	        ...
	        <li style="cursor: pointer;" ><!--onclick="save_Pay(1);"  -->
				<div class="payment-item  online-payment " for="pay-method-1"
					payname="货到付款" payid="1"><b></b>货到付款<span class="qmark-icon qmark-tip" data-tips="送货上门后再收款，支持现金、POS机刷卡、支票支付 <a href='#' target='_blank' class='ftx-05'>查看服务及配送范围</a>"></span>					                                        																										<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.jd.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
			...
			<li style="cursor: pointer;" ><!--onclick="save_Pay(4);"  -->
				<div class="payment-item  online-payment " for="pay-method-4"
					payname="在线支付" payid="4"><b></b>在线支付 <font class="whiteBarSpanClass hide" color="#FF6600">[支持打白条]</font> 																	<span class="qmark-icon qmark-tip" data-tips="即时到帐，支持绝大数银行借记卡及部分银行信用卡 <a href='http://www.jd.com/help/onlinepay.aspx' target='_blank' class='ftx-05'> 查看银行及限额</a>"></span> 									<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.jd.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
			...
			<li style="cursor: pointer;"><!-- onclick="save_Pay(5); "  -->
				<div class="payment-item item-selected online-payment " for="pay-method-5" payname="公司转账" payid="5"><b></b>
					公司转账 <span class="qmark-icon qmark-tip" data-tips="通过快钱平台转账 转帐后1-3个工作日内到帐 <a href='#' target='_blank' class='ftx-05'>查看帐户信息</a>"></span> 					<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.jd.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
			...
			<li style="cursor: pointer;"><!-- onclick="save_Pay(2);   -->
				<div class="payment-item  online-payment " for="pay-method-2" payname="邮局汇款" payid="2"><b></b>
...
<script type="text/javascript" >
	...
	function setDefault(takeId){
		if(takeId!=null){
			$.ajax({
		 		   type: "PUT",
		 		   url: "/ship/setDefalutTake.html",
		 		   data: {'takeId':takeId},
		 		   statusCode : {
		 			   204:function(){
		 				  queryTaskList();
		 			   ...
		 			   500:function(){
		 				   $.messager.alert('提示','设置默认收货地址失败!');
		 			   }
		 		   }
		 		});
		}
		else{
		   $.messager.alert('提示','未选中收货地址!');
	...
	function takeedit(e){
		...
		$win = $('#shipEdit').window({
		    ...
		    modal: true,
		    closed: true,
		    href:'/ship/queryTake/'+e+'.html'
		});
		$('#shipEdit').window('open');
	}
	...
	function deleteTake(takeId){
		if(takeId!=null){
			$.ajax({
		 		   type: "POST",
		 		   url: "/ship/deleteTake.html",
		 		   data: {'takeId':takeId, '_method':'DELETE'},
		 		   statusCode : {
		 			   204:function(){
		 				  queryTaskList();
		 			   },
		 			   500:function(){
		 				   $.messager.alert('提示','删除收货地址失败!');
		 			   }
		 		   }
		 		});
		}
		else{
		   $.messager.alert('提示','未选中收获地址!');
         ...
         <!--配送方式-->
                  ...
                  <div class="mode-tab-nav">
                    ...
                    <ul>
                        ...
                        <li class="mode-tab-item " id="pick_shipment_item" onclick="doSwithTab('picksite')">
...
<div class="step-content">
	<!-- <div id="part-inv" class="invoice-cont">
		<span class="mr10"> 普通发票（电子） &nbsp; </span><span class="mr10"> 个人 &nbsp; </span><span class="mr10"> &nbsp; </span>明细 
     	<a href="#none" class="ftx-05 invoice-edit" onclick="edit_Invoice()">修改</a>
	</div> -->
	<br />
	
	<ul>
		<li><input type="radio" name="invocieMode1" value="不需要发票" onclick="invocieNot()" checked="true" id="invocieNotId" />不需要发票</li>
		<li><input type="radio" name="invocieMode1" value="普通发票" onclick="invocieCommon(this)"/>普通发票</li>
		<li><input type="radio" name="invocieMode1" value="电子发票" onclick="invocieElectronic(this)"/>电子发票</li>
	</ul>
	
	<div id="invocieGd"></div>
</div>

<div id="invocieCommon" class="easyui-window" title="普通发票" 
		data-options="modal:true,closed:true,href:'/invocie/invocieCommon.html'" 
		style="width:400px;height:300px;padding:10px;">
</div>

<div id="invocieElectronic" class="easyui-window" title="电子发票" 
		data-options="modal:true,closed:true,href:'/invocie/invocieElectronic.html'" 
		style="width:400px;height:400px;padding:10px;">
</div>

<script type="text/javascript" >
	/* $(function(){
		document.getElementById("invocieNotId").defaultChecked;
	}) */
	
	function invocieNot(){
		$("#hiddenInvocieHead").val("");
		$("#hiddeninvocieContent").val("");
		$("#hiddeninvocieMode").val("不开发票");
		$("#hiddeninvociePhone").val("");
		$("#hiddeninvocieName").val("");
	}
	
	
	var hhhh=0;

	function invocieCommon(e){
		hhhh=$(e).position().top;
		$win = $('#invocieCommon').window({
		    title: '普通发票',
		    width: 400,
		    height: 300,
		    top: hhhh-200,
		    ...
		    maximizable: false,
		    collapsible: false,
		    href:'/ship/invocieCommon.html'
		});
		$("#invocieCommon").window('open');
	}
	
	function invocieElectronic(e){
		hhhh=$(e).position().top;
		$win = $('#invocieElectronic').window({
		    title: '电子发票',
		    width: 400,
		    height: 400,
		    top: hhhh-200,
		    ...
		    maximizable: false,
		    collapsible: false,
		    href:'/ship/invocieElectronic.html'
		});
		$("#invocieElectronic").window('open');
	}
	...
	/*$('#invocieGd').datagrid({
		toolbar: [{
			text:'不需要发票',
			handler: function(){alert('设置为默认地址')}
...
<div class="order-summary">
	<!--  预售 计算支付展现方式 begin -->
		...
		<div class="list">
			<span><em class="ftx-01">${totalNum }</em> 件商品，总商品金额：</span>
			<em class="price" id="warePriceId" v="0.00">￥<fmt:formatNumber value="${totalPrice / 1000}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></em>
		</div>
		<div class="list">
			<span>返现：</span>
    ...
    <div class="list" id="showFreeFreight"  style="display:none;" >
      <span>运费优惠：</span><em class="price" id="freeFreightPriceId"> -￥0.00</em>
		...
		<div class="list">
			<span>应付总额：</span>
			<em class="price" id="sumPayPriceId"> ￥<fmt:formatNumber value="${totalPrice / 1000}" maxFractionDigits="2" minFractionDigits="2" groupingUsed="true"/></em>
		</div>
	</div>
		<div class="clr"></div>
	</div>
