...
<script type="text/javascript" src="/js/uploadAndValidate.js"></script>
...
function checkNumberImage(){
	...
	imageNumber.src = "/captche.html?timestamp="+new Date().getTime();
}
	function show(a){
		$(a).prevAll("a").each(function(){
			$(this).css("background","url(/images/commstar.jpg) left top repeat-x");
		});
		$(a).css("background","url(/images/commstar.jpg) left top repeat-x");
		$(a).nextAll("a").each(function(){
			$(this).css("background","none left top repeat-x");
		});
		//alert($(a).attr("_val"));
		$("input[name='commentStar']").attr("value",$(a).attr("_val"));
	}
	 ...
	 $(window).keypress(function(event){
		  ...
		  case 13:
			...
			if($.trim(_value)==""){
				...
				var a = "<li vid='132'><input type='checkbox'checked='checked' disabled='true' name='+_value+' value='"+_value+"'/>"+_value+"";
				$(".list-last").before(a);
				$(".itxt").val("");
				$("#idtext").hide();
		       break;
		...
		$.ajax({
			type : "GET",
			dataType:"jsonp",
			url : "http://comment.taotao.com/tag/"+${iteminfo.itemId},
			success : function(data) {
				if(data!=null){
					 for(var i=0; i<=data.length;i++ ){
						var a = "<li vid='132'><input type='checkbox' name='_value' value ='"+data[i].tagname+"'  />"+data[i].tagname+"";
						$(".list-last").before(a);
					}  
				}
	...
	$(function(){
		...
		$(".pingjiaEl").bind("click",function(){
	        ...
	        $(".pics a").each(function(){
	        	...
	        	tagArray2.push($(this).attr("href"));
	        });
			var temp = document.createElement("form");
			temp.action = "http://www.taotao.com/item/save.html";
			temp.method = "post";
			...
			opt.name="itemid";
			opt.value=${iteminfo.itemId};
			temp.appendChild(opt);
			
			var opt1=document.createElement("input");
			opt1.setAttribute("type", "text");
			opt1.name="itembuytime";
			opt1.value=${iteminfo.itemBuyTime};
			temp.appendChild(opt1);
			
			var opt2=document.createElement("input");
			opt2.setAttribute("type", "text");
			opt2.name="score";
			opt2.value=$("input[name='commentStar']").attr("value");
			temp.appendChild(opt2);
			
			var opt3=document.createElement("input");
			opt3.setAttribute("type", "text");
			opt3.name="content";
			//opt3.value=$("textarea[name='commentcontent']").val();
			opt3.value=$("textarea[name='commentcontent']").val();
			...
			opt4.name="pic";
			opt4.value=tagArray2.join(",");
			temp.appendChild(opt4);
			
			var opt5=document.createElement("input");
			opt5.setAttribute("type", "text");
			opt5.name="tags";
			opt5.value=tagArray.join(",");
			temp.appendChild(opt5);
			
			var opt6=document.createElement("input");
			opt6.setAttribute("type", "text");
			opt6.name="orderid";
			opt6.value=${iteminfo.orderId};
                                            ...
                                            <ul class="pro-info" oid="3122336930" pid="975788">
                                                <li class="fore1">
                                                    <div class="p-info clearfix">
                                                        <div class="p-img fl">
                                                            <a target="_blank" href="http://www.taotao.com/item/${iteminfo.itemId}.html">
                                                                <img width="50" height="50" title="${iteminfo.itemTitle}" data-img="1" src="${iteminfo.itemImageUrl}" class="err-product">
                                                            </a>
                                                        </div>
                                                        <div class="p-name fl">
                                                            <a target="_blank" href="http://www.taotao.com/item/${iteminfo.itemId}.html">${iteminfo.itemTitle}</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="fore2">
                                                    <span class="ftx03">${iteminfo.itemBuyTime}</span>
                                                </li>
                                            ...
                                            <div class="clr"></div>
                                                ...
                                                <div class="form" tagflag="true" isconspros="0" pid="975788">
                                                    ...
                                                    <div class="item"><span class="label"><em>*</em>评分：</span>
                                                        <div class="fl">
                                                            <span class="commstar">
                                                                <a href="javascript:;" onclick="show(this)" class="star1" _val="1"></a>
                                                                <a href="javascript:;" onclick="show(this)" class="star2" _val="2"></a>
                                                                <a href="javascript:;" onclick="show(this)" class="star3" _val="3"></a>
                                                                <a href="javascript:;" onclick="show(this)" class="star4" _val="4"></a>
                                                                <a href="javascript:;" onclick="show(this)" class="star5" _val="5"></a>
                                                            </span>
                                                    ...
                                                    <input id ="itemid" type="hidden" value="${itemid}"/>
                                                        ...
                                                        <div class="fl">
                                                            ...
                                                            <ul class="tips-list">
                                                           <!-- 	<li vid="132"><input type="checkbox"/>复印速度快</li>
                                                            ...
                                                            <li vid="137"><s class="f-check"></s>墨盒便宜</li> -->
                                                                <li class="list-last">
                                                                    ...
                                                                    <div class="fore2 hide" id="idtext"   >
                                                    ...
                                                    <div class="item item01 xindeEl" >
                                                        ...
                                                        <div class="cont">
                                                            <textarea name="commentcontent" cols="" rows="" class="area area01">商品是否给力？快分享你的购买心得吧~</textarea>
                                                            <div class="clr"></div>
                                                    ...
                                                    <div class="isL item">
                                                        ...
                                                        <div class="fl">
                                                            ...
                                                            <img src="/captche.html" name="imageNumber" id="imageNumber" style="cursor:hand" title="点击可更换图片" height="30" onclick="checkNumberImage()"/>
                                                    ...
                                                    <div class="item item02">
                                                        ...
                                                        <div class="fl">
                                                            <a href="#none" class="btn btn-5 mr20" onclick="submit();">
                                                                <s></s>
