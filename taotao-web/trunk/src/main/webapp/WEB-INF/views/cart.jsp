...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <link href="/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css"></link>
   ...
   <script type="text/javascript" src="/js/jquery-easyui-1.4.1/jquery.easyui.min.js"/>
   <script type="text/javascript" src="/js/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js"/>
   ...
   <script type="text/javascript">
   	...
   	$(function(){
   		...
   		$("#remove-batch").click(function(){
   			...
   			$.messager.confirm('确认','确定删除购物车中的商品吗？',function(r){
   				
   				if (r){
   					
   					$.ajax({
   						type: "DELETE",
	        			url: "/service/cart/delete/"+ids,
	        			success: function(msg){
        				   $.messager.alert('提示','删除购物车中商品成功!',undefined,function(){
        					   
        					   window.location="/cart/show.html";
           				   
        				   });
	        			},
        			    error: function(msg){
        				   $.messager.alert('提示','删除购物车中商品失败!',undefined,function(){
	...
	function _toSettlement(){
		
		var ids = _getSelecteds();
		
		if(ids.length == 0){
			$.messager.alert('提示','您还没有选择要结算的商品!');
			return;
		}
 		
		ids=ids.join(",");
		window.location.href="http://www.taotao.com:8082/order/create/"+ids+".html";
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        <div class="column t-checkbox form"><input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" checked="" value="" class="check-all"></input><label for="toggle-checkboxes_up">全选</label></div>
        ...
        <c:forEach items="${cartList}" var="cart">
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            <div class="cell p-checkbox"><input data-bind="cbid:1" class="checkbox" type="checkbox" name="checkItem" checked="" value="11345721-1"></input></div>
		            ...
		            <div class="cell p-quantity" for-stock="for-stock-11345721">
		                <div class="quantity-form" data-bind="">
		                    ...
		                    <input type="text" class="quantity-text" itemPrice="${cart.itemPrice}" itemId="${cart.itemId}" value="${cart.num }"  id="changeQuantity-11345721-1-1-0" ></input>
		                    <input type="hidden" id="_changeBeforeNum" value="${cart.num }" ></input>         
          ...
          <div class="cart-toolbar clearfix">
            <div class="total fr">
                <p><span class="totalSkuPrice"></span>总计：</p>
        ...
        <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;"><div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
          <div class="control fdibu fdibucurrent">
              <span class="column t-checkbox form">
                  <!-- <input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_down" type="checkbox" checked="" value="" class="jdcheckbox" ></input> -->
                  <input data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_down" type="checkbox" checked="" value="" class="jdcheckbox check-all" ></input>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      ...
                      <a class="checkout" href="javascript:void(0);" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement" onclick="_toSettlement();">去结算<b></b></a>
              ...
              <div class="total fr">
                  ...
                  <span class="totalSkuPrice" id="totalSkuPrice"></span>
              </div>
          </div>
      </div></div>
</div><!-- cart-inner结束 -->
