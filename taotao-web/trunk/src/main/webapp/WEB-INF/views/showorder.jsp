						...
						<div class="mod-main mod-comm lefta-box" id="order02">
							<div class="mt">
								<ul class="taborder">
									<li>
										<div class="tyies-t">
											<strong class="ftx-01">订单详情</strong>
										</div>
										<div class="tyies-c">
											<div class="close"></div>
											...
											<tbody id="tb-2538292730">
												...
												<tr class="tr-th">
													<td colspan="6"><span class="tcol1"> 订单编号: <a
															...
															href="http://www.taotao.com/order/view/${order.orderId }/${order.orderItem.itemId }.html"
												...
												<tr id="track2538292730" oty="0,1,70" class="tr-td">
													...
													<td id="operate2538292730" class="order-doi" width="100">
														...
														<a target="_blank"
														href="http://www.taotao.com/order/view/${order.orderId }.html"
														...
														href="http://www.taotao.com/cart/items/${order.orderId }.html"
														target="_blank">还要买</a>                       
														<!-- <a class="btn-again" clstag="click|keycount|orderlist|buy"
						...
						<div class="mc">
							<table class="tb-void tb-left">
								...
								<tbody>
									...
									<tr>
										<td>地址</td>
										<td>${order.orderShipping.receiverCity }${order.orderShipping.receiverDistrict }${order.orderShipping.receiverAddress }</td>
									</tr>
									<tr>
										<td>手机号码</td>
						...
						<div class="mc">
							<table class="tb-void tb-left">
								...
								<tbody>
	  		                    	<tr>
										<td>收票人姓名</td>
										<td>${invocie.invocieName }</td>
									</tr>
									<tr>
										<td>收票人联系方式</td>
										<td>${invocie.invociePhone }</td>
									</tr>
									<tr>
										<td>发票类型</td>
										<td>${invocie.invocieType }</td>
									</tr>
									<tr>
										<td>开票方式</td>
										<td>${invocie.invocieMode }</td>
									</tr>
									<tr>
										<td>发票台头</td>
										<td>${invocie.invocieHead }</td>
									</tr>
									<tr>
										<td>发票内容</td>
										<td>${invocie.invocieContent }</td>
									</tr>
								</tbody>
							</table>
							</div>
						...
						<div class="mc">
							<table class="tb-void tb-left">
								...
								<tbody>
									<tr>
										<td>商品金额</td>
										<td>${order.payment}元 - 优惠金额：0.00元 + 运费：${order.postFee }元= 订单总金额：<strong class="ftx-01">${order.payment}</strong>元</td>
									</tr>
								</tbody>
							</table>
						</div>
