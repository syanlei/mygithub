 ...
 */
function login() {
    return location.href = "http://www.taotao.com/user/login.html";
}
function regist() {
    return location.href = "http://www.taotao.com/user/register.html";
}
...
function search(a) {
    var b = "http://search.taotao.com/search?keyWords=" + encodeURIComponent(document.getElementById(a).value);
    ...
    for (var b = a.getElementsByTagName("img"), c = 0; c < b.length; c++)
        b[c].onerror = function() {
            ...
            if (b) {
                ...
                this.src = "http://www.taotao.com/images/blank.gif", this.className = a
            }
        }
