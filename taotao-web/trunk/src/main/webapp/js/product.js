...
var Refresh = {init: function() {
        ...
        //回显：ajax的jsonp格式直接用！！！不用写callback：有默认！！！
//        this.url = "/js/comment.json", 
        //调用前台item.jsp的js获取商品id：window.pageConfig.product.skuid
        this.url = "http://comment.taotao.com/comment/"+window.pageConfig.product.skuid;
        ...
        $.ajax({url: this.url,dataType: "jsonp",success: function(t) {
                a.setData(t)
            }})
