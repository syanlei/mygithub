...
public class OrderController {
     ...
     */
    @ResponseBody
    @RequestMapping("/query/status/{buyerNick}/{status}/{page}/{count}")
    public PageResult<Order> queryOrderByUserNameAndStatus(@PathVariable("buyerNick") String buyerNick,
            @PathVariable("status") Integer status, @PathVariable("page") Integer page,
            @PathVariable("count") Integer count) {
        return orderService.queryOrderByUserNameAndStatus(buyerNick, status, page, count);
    }
     ...
     */
    @ResponseBody
    @RequestMapping("/query/time/{buyerNick}/{date}/{page}/{count}")
    public PageResult<Order> queryOrderByUserNameAndTime(@PathVariable("buyerNick") String buyerNick,
            @PathVariable("date") Integer date, @PathVariable("page") Integer page,
            @PathVariable("count") Integer count) {
        return orderService.queryOrderByUserNameAndTime(buyerNick, date, page, count);
    }
}
