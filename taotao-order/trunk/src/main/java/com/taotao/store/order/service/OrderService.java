...
import com.taotao.store.order.mapper.FOrderMapper;
...
/*    @Autowired
    ...
    public TaotaoResult createOrder(String json) {
        ...
        try {
            ...
            order.setInvocieId(orderId + "invocieId");
...
*/
    ...
    public PageResult<Order> queryOrderByUserNameAndStatus(String buyerNick, Integer status, Integer page,
        ...
        return orderDao.queryOrderByUserNameAndStatus(buyerNick, status, page, count);
    }

    public PageResult<Order> queryOrderByUserNameAndTime(String buyerNick, Integer date, Integer page,
            Integer count) {
        return orderDao.queryOrderByUserNameAndTime(buyerNick, date, page, count);
    }
